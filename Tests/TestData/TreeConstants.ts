...
import {BinaryOperator} from "../../src/Operators/BinaryOperators/BinaryOperator";
...
export class TreeConstants {
    ...
    static UnaryTreeWorking = new TreeNode(
        "/",
        null,
        new TreeNode(
            "+",
            ...
            new TreeNode("x", null,
                new TreeNode("-", null, new TreeNode(null, 3, null, null),
                    new TreeNode(null, 2, null, null)),
                new TreeNode("sqrt", null, new TreeNode(null, 25, null, null), null)
            )
        ),
        new TreeNode(null, 6, null, null)
    );
